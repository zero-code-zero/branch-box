...
export const createEnv = (services, name = '', stopTime = '18:00', startTime = '') =>
  api.post('/envs', { services, name, stopTime, startTime });
...
export const deleteEnv = (stackId, type = 'archive') =>
  api.delete(`/envs?stackId=${stackId}&type=${type}`);
